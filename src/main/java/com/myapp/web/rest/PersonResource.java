...
public class PersonResource {
            ...
            .map(
                existingPerson -> {
                    if (person.getVersion() != null) {
                        existingPerson.setVersion(person.getVersion());
                    }
                    if (person.getStateCode() != null) {
                        existingPerson.setStateCode(person.getStateCode());
                    }
                    ...
                    if (person.getGenderTypeCode() != null) {
                        existingPerson.setGenderTypeCode(person.getGenderTypeCode());
                    }
    ...
    public List<Person> getAllPeople(@RequestParam(required = false) String filter) {
        if ("persondetails-is-null".equals(filter)) {
            log.debug("REST request to get all Persons where personDetails is null");
            return StreamSupport
                .stream(personRepository.findAll().spliterator(), false)
                .filter(person -> person.getPersonDetails() == null)
